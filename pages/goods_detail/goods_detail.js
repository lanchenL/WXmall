...
Page({
  ...
  async getGoodsDetail(goods_id) {
    ...
    // 将富文本里面的https改成https
    goodsObj.data.message.goods_introduce = goodsObj.data.message.goods_introduce.replace(/http:/, 'https:');
    goodsObj.data.message.goods_introduce = goodsObj.data.message.goods_introduce.replace(/data-src\=\"\/\/image/, 'data-src="https://image');
    goodsObj.data.message.goods_introduce = goodsObj.data.message.goods_introduce.replace(/src\=\"\/\/image/, 'src="https://image');
